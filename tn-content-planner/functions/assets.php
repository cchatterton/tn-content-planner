...
function tncp_assets($hook) {
    ...
    wp_localize_script('tncp-admin', 'TNCP', array('editor' => admin_url('post.php'), 'api' => rest_url('tncp/v1/'), 'nonce' => wp_create_nonce('wp_rest'), 'types' => $types, 'pattern_counts' => tncp_pattern_counts()));
}

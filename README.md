...
Author: Techn · Version: 0.3.10 · Branding mode: Author Branded
...
- Each content tab shows WordPress’s runtime Public, Publicly Queryable, Exclude From Search and Hierarchical settings as navy ticks or orange crosses, plus a Native or Custom declaration. Values refresh with the catalog; unusual non-boolean values are displayed literally for diagnosis.
